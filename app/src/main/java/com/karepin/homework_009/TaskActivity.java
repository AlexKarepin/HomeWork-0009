...
public class TaskActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        // метод показывающий календарь для выбора старта задачи
        ...
        // метод показывающий календарь для выбора окончания задачи
        ...
        // метод выбора даты старта задачи
        ...
        // метод выбора даты окончания задачи
    ...
    // метод провекри на правильность ввода данных (дата начала не должна быть меньше даты окончания)
    // и вывода введенных данных на экран
    private void inputButtonOk() {
        Button mBtnOK = findViewById(R.id.btnOK);
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mStartDate > mEndDate) {
                    Toast.makeText(TaskActivity.this, "Ошибка", Toast.LENGTH_LONG).show();
                    mChooseStartDate.setText("Дата-время старта задачи:");
                    mChooseEndDate.setText("Дата-время окончания задачи:");
                } else {
                    Toast.makeText(TaskActivity.this, "старт: " + mStartDateTxt + " окончаниe: " + mEndDateTxt, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
